...
narrate-the-reaction :: \b(th(is|at) (one|part|bit) is (almost |nearly )?(unfair|brutal|grim|bleak|the worst|the hardest)|this is where it gets|and it gets worse|the hard(est)? part is)\b :: Then the ignition source, and this one is almost unfair.
